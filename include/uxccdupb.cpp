...
UXCCDUPB::UXCCDUPB(QWidget *parent) : QPushButton(parent)
{
    installEventFilter(this);
    setFixedSize(170,60);
}

void UXCCDUPB::paintEvent(QPaintEvent *event)
{
    QPainter mpainter;
    mpainter.begin(this);
    ...
    mpainter.drawLine(QPoint(10,10+downzoom),QPoint(85,50+downzoom));
    mpainter.drawLine(QPoint(85,50+downzoom),QPoint(85+75,10+downzoom));
    mpainter.end();
}

bool UXCCDUPB::eventFilter(QObject *watched, QEvent *event)
{
