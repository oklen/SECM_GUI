...
BOOL	PI_FUNC_DECL	PI_WriteConfigurationFromDatabaseToController(int ID, const char* szFilter, const char* szConfigurationName, char* szWarnings, int warningsBufferSize);
BOOL	PI_FUNC_DECL	PI_ReadConfigurationFromControllerToDatabase(int ID, const char* szFilter, const char* szConfigurationName, char* szWarnings, int warningsBufferSize);
BOOL	PI_FUNC_DECL	PI_GetAvailableControllerConfigurationsFromDatabase(int ID, char* szConfigurationNames, int configurationNamesBufferSize);
